...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('userview') }}/css/styles.css" rel="stylesheet" />
    ...
    <body id="page-top">
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="awards">
                <div class="resume-section-content">
                    ...
                    {!! set_list_sertifikat($sertifikat->isi) !!}
        ...
        <!-- Core theme JS-->
        <script src="{{ asset('userview') }}/js/scripts.js"></script>
    </body>
</html>
