    ...
    <form action="{{ route('education.update', $data->id)}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text"
                ...
                aria-describedby="helpId" placeholder="Masukan data dengan tepat" value="{{ $data->info2 }}">
        </div>
        <div class="mb-3">
            <label for="info3" class="form-label">Nilai Akhir</label>
            <input type="text"
                class="form-control form-control-sm" name="info3" id="info3" 
                aria-describedby="helpId" placeholder="Masukan data dengan tepat" value="{{ $data->info3 }}">
        </div>
        <div class="mb-3">
            <div class="row">
